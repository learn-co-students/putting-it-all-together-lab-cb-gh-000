...
export default (state={}, action) => {
    switch (action.type) {
      ...
      case "HIT_AI":
        ...
        let removeAiCards = aiState.deck.findIndex((card)=>card===action.payload);
        aiState.deck.splice(removeAiCards,1);
      ...
      case "HIT_USER":
        ...
        let removeUserCards = userState.deck.findIndex((card)=>card===action.payload);
        userState.deck.splice(removeUserCards,1);
